...
const SelectCenter=({insertSiteCenter, site})=>{
    return(
        <div className='mb-5 mt-4'>
            ...
            <span className='is-inline-block mr-3 ml-3'></span>
            <span className={`${site==='Register'?'':'has-text-grey-light'} has-text-weight-semibold is-pointer is-size-5`} id="Register" onClick={(e)=>{
                insertSiteCenter('Register')
            }}>Registrar</span>
        </div>
)
}
